...
\acro{GSF}{Gold Standard File\acroextra{, for SIPP merged to administrative data}}
...
\acro{NETS}{National Establishment Time Series}
...
\acro{NISS}{the National Institute of Statistical Sciences}
...
\acro{SEIN}{State employer identification number}
...
\acro{SJIAOS}{Statistical Journal of the IAOS}
...
\acro{SSC}{Statistical Software Components\acroextra{, at \url{http://econpapers.repec.org/software/bocbocode/}, and accessible from within Stata}}
